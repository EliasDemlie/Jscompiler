...
arrow_function_declaration:
     modifier IDENTIFIER ASSIGN LPAREN parameter_list RPAREN ASSIGN GT block
    | CONST IDENTIFIER ASSIGN LPAREN parameter_list RPAREN ASSIGN GT block
...
function_call:
    ...
    | IDENTIFIER ASSIGN IDENTIFIER LPAREN argument_list RPAREN
    | modifier IDENTIFIER ASSIGN IDENTIFIER LPAREN argument_list RPAREN
    | CONST IDENTIFIER ASSIGN IDENTIFIER LPAREN argument_list RPAREN
